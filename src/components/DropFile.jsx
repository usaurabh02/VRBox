...
export const DropFile = () => {
  ...
  return (
    <div
      className="w-full md:h-[515px] pb-[80px] items-center bg-[#dfdbe6]"
      id="stream"
    >
      ...
      <div className=" mt-[7rem] gap-[70px] my-auto  flex flex-wrap justify-center mx-auto">
        <div className="flex flex-col md:flex-row gap-4  md:gap-16">
          ...
          <div className="m-auto">
            <h2 className="m-auto text-center py-2 font-bold text-[#242125]">
              OR
            </h2>
          </div>
          <form className="my-auto">
            ...
            <div className="mt-[-15px] mx-auto">
              ...
              <p
                className={
                  "max-w-[790px] text-red-500 mt-4 font-semibold mx-auto"
                }
              >
                {error}
              </p>
